...
//2-ой параметр - исходная позиция(откуда будем перемещать элементы), куда вставляем новый элемент (откуда начать перекладывать)
//3-ий параметр - куда будем складывать элементы
//4-ой параметр - с номера какого элемента мы будем перекладывать элементы(начиная с какого индекса перезаписывать данные)
